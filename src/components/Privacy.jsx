    ...
    <div className="min-h-screen w-full pt-8 md:pt-24 px-6 md:px-12">
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-16">
          <h2 className="text-3xl mb-6 text-gray-900">SUMMARY OF KEY POINTS</h2>
        ...
        <section id="infocollect" className="mb-16">
          <h2 className="text-3xl mb-6 text-gray-900">1. WHAT INFORMATION DO WE COLLECT?</h2>
          <div className="space-y-6 text-lg text-gray-800">
            <h3 className="text-2xl mb-4 text-gray-900">Personal information you disclose to us</h3>
            ...
            <div className="ml-6">
              <h4 className="text-xl mb-2">Personal Information Provided by You:</h4>
       ...
       {/* Information Processing Section */}
        <section id="infouse" className="mb-16">
          <h2 className="text-3xl mb-6 text-gray-900">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
          <div className="space-y-6 text-lg text-gray-800">
            <p className="italic"><strong>In Short:</strong> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law.</p>
        ...
        {/* Legal Bases Section */}
        <section id="legalbases" className="mb-16">
          <h2 className="text-3xl mb-6 text-gray-900">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</h2>
          <div className="space-y-6 text-lg text-gray-800">
            <p className="italic"><strong>In Short:</strong> We only process your personal information when we believe it is necessary and we have a valid legal reason to do so under applicable law.</p>
        ...
        <section id="whoshare" className="mb-16">
          <h2 className="text-3xl mb-6 text-gray-900">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
          <div className="space-y-6 text-lg text-gray-800">
            <p className="italic"><strong>In Short:</strong> We may share information in specific situations and with specific categories of third parties.</p>
        ...
        <section id="cookies" className="mb-16">
          <h2 className="text-3xl mb-6 text-gray-900">5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
          <div className="space-y-6 text-lg text-gray-800">
            ...
            <div className="space-y-4">
              ...
              <h3 className="text-2xl mt-8 mb-4 text-gray-900">Google Analytics</h3>
              <p>We may share your information with Google Analytics to track and analyse the use of the Services. The Google Analytics Advertising Features that we may use include: Google Analytics Demographics and Interests Reporting.</p>
            </div>
          </div>
        </section>

       {/* Data Retention Section */}
       <section id="inforetain" className="mb-16">
         <h2 className="text-3xl mb-6 text-gray-900">6. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
         <div className="space-y-6 text-lg text-gray-800">
       ...
       <section id="infosafe" className="mb-16">
         <h2 className="text-3xl mb-6 text-gray-900">7. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
         <div className="space-y-6 text-lg text-gray-800">
           <p className="italic"><strong>In Short:</strong> We aim to protect your personal information through a system of organisational and technical security measures.</p>
       ...
       {/* Minors Section */}
       <section id="infominors" className="mb-16">
         <h2 className="text-3xl mb-6 text-gray-900">8. DO WE COLLECT INFORMATION FROM MINORS?</h2>
         <div className="space-y-6 text-lg text-gray-800">
           <p className="italic"><strong>In Short:</strong> We do not knowingly collect data from or market to children under 18 years of age.</p>

           <p>We do not knowingly collect, solicit data from, or market to children under 18 years of age. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent's use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at alexanderbloom@waytrack.co.uk.</p>
         </div>
       </section>

       {/* Privacy Rights Section */}
       <section id="privacyrights" className="mb-16">
         <h2 className="text-3xl mb-6 text-gray-900">9. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
         <div className="space-y-6 text-lg text-gray-800">
           <p className="italic"><strong>In Short:</strong> In some regions, such as the European Economic Area (EEA), United Kingdom (UK), and Switzerland, you have rights that allow you greater access to and control over your personal information.</p>

           <div className="space-y-4">
             <p>In some regions (like the EEA, UK, and Switzerland), you have certain rights under applicable data protection laws. These may include the right:</p>
             <ul className="list-disc pl-6 space-y-2">
             ...
             <div className="mt-8">
               <h3 className="text-2xl mb-4 text-gray-900">Account Information</h3>
       ...
       <section id="DNT" className="mb-16">
         <h2 className="text-3xl mb-6 text-gray-900">10. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
         <div className="space-y-6 text-lg text-gray-800">
           <p>Most web browsers and some mobile operating systems and mobile applications include a Do-Not-Track ('DNT') feature or setting you can activate to signal your privacy preference not to have data about your online browsing activities monitored and collected. At this stage, no uniform technology standard for recognising and implementing DNT signals has been finalised. As such, we do not currently respond to DNT browser signals or any other mechanism that automatically communicates your choice not to be tracked online.</p>
         </div>
       </section>

       {/* Updates to Notice Section */}
       <section id="policyupdates" className="mb-16">
         <h2 className="text-3xl mb-6 text-gray-900">11. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
         <div className="space-y-6 text-lg text-gray-800">
       ...
       <section id="contact" className="mb-16">
         <h2 className="text-3xl mb-6 text-gray-900">12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
         <div className="space-y-6 text-lg text-gray-800">
           <p>If you have questions or comments about this notice, you may email us at alexanderbloom@waytrack.co.uk or contact us by post at:</p>

           <div className="pl-6 border-l-2 border-gray-300 my-4">
             <p>Waytrack Ltd</p>
             <p>176 Clarence Gate Gardens</p>
             <p>Glentworth Street</p>
             <p>London, Greater London NW1 6AR</p>
             <p>England</p>
           </div>
         </div>
       </section>
